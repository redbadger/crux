...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_e986_rustbuffer_alloc(size, status).also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_e986_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_shared_e986_Platform_init_callback(
        `callbackStub`: ForeignCallback,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun shared_e986_add_for_platform(
        `left`: Int,
        `right`: Int,
        `platform`: Long,
        _uniffi_out_err: RustCallStatus
    ...
    fun shared_e986_cat_fact(
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_e986_rustbuffer_alloc(
        `size`: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_e986_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_e986_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_shared_e986_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
public object FfiConverterTypePlatform : FfiConverterCallbackInterface<Platform>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_shared_e986_Platform_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `addForPlatform`(`left`: UInt, `right`: UInt, `platform`: Platform): String {
    return FfiConverterString.lift(
        rustCallWithError(PlatformException) { _status ->
            _UniFFILib.INSTANCE.shared_e986_add_for_platform(FfiConverterUInt.lower(`left`), FfiConverterUInt.lower(`right`), FfiConverterTypePlatform.lower(`platform`), _status)
        }
    )
}
...
fun `catFact`(): String {
    return FfiConverterString.lift(
        rustCall() { _status ->
            _UniFFILib.INSTANCE.shared_e986_cat_fact(_status)
        }
    )
}
