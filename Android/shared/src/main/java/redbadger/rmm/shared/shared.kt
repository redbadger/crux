...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_9e24_rustbuffer_alloc(size, status).also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_9e24_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_shared_9e24_CatFact_object_free(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun shared_9e24_CatFact_new(
        `fact`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus
    ): Pointer

    fun shared_9e24_CatFact_format(
        `ptr`: Pointer,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_9e24_Platform_init_callback(
        `callbackStub`: ForeignCallback,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun shared_9e24_add_for_platform(
        `left`: Int,
        `right`: Int,
        `platform`: Long,
        _uniffi_out_err: RustCallStatus
    ...
    fun ffi_shared_9e24_rustbuffer_alloc(
        `size`: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_9e24_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_9e24_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_shared_9e24_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
public interface CatFactInterface {
...
class CatFact(
    pointer: Pointer
) : FFIObject(pointer), CatFactInterface {
    constructor(`fact`: CatFactData) :
        this(
            rustCall() { _status ->
                _UniFFILib.INSTANCE.shared_9e24_CatFact_new(FfiConverterTypeCatFactData.lower(`fact`), _status)
            }
        )
    ...
    protected override fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_9e24_CatFact_object_free(this.pointer, status)
        }
    }
    ...
    override fun `format`(): String =
        callWithPointer {
            rustCall() { _status ->
                _UniFFILib.INSTANCE.shared_9e24_CatFact_format(it, _status)
            }
        }.let {
...
public object FfiConverterTypeCatFact : FfiConverter<CatFact, Pointer> {
    override fun lower(value: CatFact): Pointer = value.callWithPointer { it }

    override fun lift(value: Pointer): CatFact {
        return CatFact(value)
    }

    override fun read(buf: ByteBuffer): CatFact {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: CatFact) = 8

    override fun write(value: CatFact, buf: ByteBuffer) {
...
public object FfiConverterTypeCatFactData : FfiConverterRustBuffer<CatFactData> {
    override fun read(buf: ByteBuffer): CatFactData {
        return CatFactData(
    ...
    override fun allocationSize(value: CatFactData) = (
        FfiConverterString.allocationSize(value.`fact`) +
            FfiConverterInt.allocationSize(value.`length`)
        )

    override fun write(value: CatFactData, buf: ByteBuffer) {
        FfiConverterString.write(value.`fact`, buf)
        FfiConverterInt.write(value.`length`, buf)
    }
}
...
public object FfiConverterTypePlatform : FfiConverterCallbackInterface<Platform>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_shared_9e24_Platform_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `addForPlatform`(`left`: UInt, `right`: UInt, `platform`: Platform): String {
    return FfiConverterString.lift(
        rustCallWithError(PlatformException) { _status ->
            _UniFFILib.INSTANCE.shared_9e24_add_for_platform(FfiConverterUInt.lower(`left`), FfiConverterUInt.lower(`right`), FfiConverterTypePlatform.lower(`platform`), _status)
        }
    )
}
