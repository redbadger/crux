...
public final class HttpResponse {
    ...
    public final com.novi.serde.Bytes body;

    public HttpResponse(@com.novi.serde.Unsigned Short status, java.util.List<HttpHeader> headers, com.novi.serde.Bytes body) {
    ...
    public static HttpResponse deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.body = deserializer.deserialize_bytes();
    ...
    public static final class Builder {
        ...
        public com.novi.serde.Bytes body;
