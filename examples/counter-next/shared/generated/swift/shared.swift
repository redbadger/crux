...
public func handleResponse(_ id: UInt32, _ data: Data) -> Data  {
...
public func processEvent(_ data: Data) -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_shared_checksum_func_handle_response() != 63659) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared_checksum_func_process_event() != 64130) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared_checksum_func_view() != 5485) {
        return InitializationResult.apiChecksumMismatch
    }
