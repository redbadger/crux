...
RustBuffer uniffi_shared_fn_func_handle_response(uint32_t id, RustBuffer data, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FUNC_PROCESS_EVENT
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FUNC_PROCESS_EVENT
RustBuffer uniffi_shared_fn_func_process_event(RustBuffer data, RustCallStatus *_Nonnull out_status
);
#endif
